/****************************************************************************
** Meta object code from reading C++ file 'my_board.h'
**
...
#include <memory>
#include "../../../ChessBoard/my_board.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'my_board.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 24), // "on_pushButton_sg_clicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "MyBoard\0on_pushButton_sg_clicked\0"
};
...
void MyBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_pushButton_sg_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
